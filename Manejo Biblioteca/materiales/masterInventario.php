...
// }
	...
	$sentencia_select=$conectarbd->query('SELECT * FROM inventario ORDER BY ISBNISSN');
...
<?php 
    ...
    $buscar=$conectarbd->query("SELECT * from inventario where ISBNISSN='$usuario_conectado' ");
		...
		<table>
			...
			<?php foreach($resultado as $fila):?>
				<tr >
					...
					<td><?php echo $fila['nombreinstitucion']; ?></td>
					<td><?php echo $fila['nombreconferencia']; ?></td>
					...
					<td><?php echo $fila['tipomaterial']; ?></td>
					...
					<td><a href="=actualizar.php?ISBNISSN<?php echo $fila['ISBNISSN']; ?>"  class="btn__update" >Editar</a></td>
					<td><a href="eliminar.php?ISBNISSN=<?php echo $fila['ISBNISSN']; ?>" class="btn__delete">Eliminar</a></td>
